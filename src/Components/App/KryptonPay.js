    ...
    <div className="container">
      <div className="row overlap-gap-section">
        ...
        <div className="col-12 col-lg-2 offset-xl-1 col-md-4 sm-margin-20px-bottom">
          <span className="d-block text-small text-uppercase margin-20px-bottom md-margin-10px-bottom"></span>
          <span className="alt-font text-extra-medium line-height-28px text-extra-dark-gray d-block w-85 md-w-75 xs-w-100"></span>
        </div>
        <div className="col-12 col-lg-2 col-md-4 sm-margin-20px-bottom">
          ...
          <span className="alt-font text-extra-medium line-height-28px text-extra-dark-gray d-block w-85 md-w-60 xs-w-100">Crypto payment solutions</span>
        </div>
        <div className="col-12 col-lg-3 col-md-4">
          <span className="d-block text-small text-uppercase margin-20px-bottom md-margin-10px-bottom">Client</span>
          <span className="alt-font text-extra-medium line-height-28px text-extra-dark-gray d-block w-85 xs-w-100">Boolean Tech</span>
        </div>
      </div>
    </div>
  </section>
